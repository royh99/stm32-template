...
{
	systick_set_clocksource(STK_CSR_CLKSOURCE_AHB_DIV8); // 96/8 = 12MHz
	//systick_set_reload(11999); // 1ms
	systick_set_reload((rcc_ahb_frequency/8) - 1); // 1 sec tick
...
{
	scount++; // increment time_value for seconds
}
